...
public class PageUtils {
     ...
     * @return
     */
    public static PageBean<Route> pageUtil(int currentPage, int totalCount, List<Route> list, int pageSize)
    {
     ...
     * @return
     */
    public static int dataTransfer(String oldData, int expectedData) {
        //判断原有数据是否为空
