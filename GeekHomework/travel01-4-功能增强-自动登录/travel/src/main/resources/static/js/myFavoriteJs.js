...
function load(uid, currentPage, rName) {
    ...
    $.get("/route/FavoritesPageQuery", {uid: uid, currentPage: currentPage, rName: rName}, function (pb) {
        ...
        var fristPage = '<li style="cursor: pointer" onclick="javascipt:load(' + uid + ',1,\'' + rName + '\')">首页</li>';
        ...
        var beforePage = '<li style="cursor: pointer"  onclick="javascipt:load(' + uid + ',' + beforeNum + ',\'' + rName + '\')" class="threeword">上一页</li>';
        ...
        */
        ...
        var lastPage = '<li style="cursor: pointer" class="threeword" onclick="javascipt:load(' + uid + ',' + pb.totalPage + ',\'' + rName + '\')">末页</li>';
        var nextPage = '<li style="cursor: pointer" class="threeword" onclick="javascipt:load(' + uid + ',' + nextPageCount + ',\'' + rName + '\')">下一页</li>';
