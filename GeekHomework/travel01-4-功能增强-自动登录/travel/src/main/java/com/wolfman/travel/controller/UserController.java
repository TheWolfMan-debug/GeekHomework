...
import com.wolfman.travel.Component.LoginComponent;
import com.wolfman.travel.Component.Md5Component;
import com.wolfman.travel.Component.RememberMeComponent;
...
public class UserController {
    ...
    public Map userLogin(User user, String rememberMeCheck, HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ...
        //确认验证码
        if (!checkCodeComponent.checkCode(request, response)) {
            map.put("flag", false);
        ...
        //检查用户登录信息
        loginComponent.loginCheck(u, map, session);
        //调用组件 记住用户
